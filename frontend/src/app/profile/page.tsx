  ...
  return (
    <Shell title="Profil" breadcrumb="Bosh sahifa · Profil">
      <div style={{ maxWidth: 820, display: "flex", flexDirection: "column", gap: 20 }}>
        ...
        {stats && (
          <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: 12 }}>
            <StatCard
              ...
              value={String(stats.all_time_total)}
              color="#0a3d2e"
            ...
            <StatCard
              label="O'rta ishonch"
              value={stats.avg_confidence ? `${stats.avg_confidence.toFixed(1)}%` : "—"}
              color="#d4a017"
        ...
        {/* App info */}
        <div style={{ textAlign: "center", padding: "8px 0 16px", fontSize: 11, fontFamily: "var(--mono)", color: "var(--muted)", letterSpacing: ".06em" }}>
